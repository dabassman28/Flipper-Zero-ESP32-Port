...
This repo is fully complete and ready to be built, using a esp32 s3, a 2.8 tft and 6 button user interface. you just need to add the tft driver when building. 
